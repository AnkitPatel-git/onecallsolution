...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Onecall Solution" },
      {
        name: "description",
        content:
          "Onecall Solution delivers enterprise IT infrastructure, networking, cyber security, cloud and managed services across India.",
      },
      { name: "author", content: "Onecall Solution" },
      {
        property: "og:title",
...
function RootComponent() {
  ...
  useEffect(() => {
    stripLovableBadge();
    const observer = new MutationObserver(stripLovableBadge);
